...
VALUES ('Boris Godunov'),
       ('Shuriks Funny adventures'),
       ('Boy o boy');
...
VALUES (1, 1, 'Not great, not terrible', 9, 'I spent two years trying to finish this movie',
        NOW()),
       (2, 2, 'Awesome story!', 5, 'I cried along the whole film, and then I realised something interesting...[Pay 20$ for the full article]',
        NOW());
