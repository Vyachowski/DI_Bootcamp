...
# 4) Create a Class Method called all_items which will return a list of all the items from the Menu_Items table.
...
# Part 2
# 5) Create a file called menu_editor.py , which will have the following functions:
