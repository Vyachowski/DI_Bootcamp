...
console.log(usersData); // -> [ [ 'user1', 18273 ], [ 'user2', 92833 ], [ 'user3', 90315 ] ]

// Modify the outcome of part 1, by multipling the user’s ID by 2.
const usersMultipliedData = usersData.map(([user, idNumber]) => [user, idNumber * 2]);
console.log(usersMultipliedData); // -> [ [ 'user1', 36546 ], [ 'user2', 185666 ], [ 'user3', 180630 ] ];
...
// ANSWER: Option 2; It contains a super function and all necessary parameters – name, size;
